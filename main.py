...
if DO_DATA_HANDLING:
    ...
    print(f'Processing data in {dh.data_dir}...')
    ...
    for filename in os.listdir(dh.data_dir):
        if filename.endswith(".csv"):
            ...
            gene_freq_file, phenotype_freq_file = dh.calculate_frequencies(df, disease_name)
...
if DO_GENE_GROUP_PRESENCE:
    ...
    df_group_presence['Total Presence Strength'] = df_group_presence.iloc[:, 1:].sum(axis=1)
